...
@torch.no_grad()
def evaluate(model, data, train_index, val_index, test_index, evaluator, loss_fn=None, return_out=False):
    model.eval()
    out = model(data) 
...
def main(args):
    ...
    for run in range(args.runs):
        ...
        for epoch in range(args.epochs):
            ...
            result = evaluate(model, data, train_index, val_index, test_index, evaluator, loss_fn)
